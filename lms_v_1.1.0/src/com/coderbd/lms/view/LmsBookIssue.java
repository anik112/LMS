...
//        String firstItem=model.getValueAt(row, 1).toString();
 //       String secondItem=model.getValueAt(row, 2).toString();
       
/*        
        txtBookId.setSelectedItem(
             firstItem+","+bookIssueService.getBookName(Integer.parseInt(firstItem))
                
        );
        txtStudentId.setSelectedItem(
             secondItem+","+bookIssueService.getStudentName(Integer.parseInt(secondItem))
        );
        */
